export default `<div class="nhsuk-feedback-banner" id="nhsuk-feedback-banner" style="display: block;">
<div class="nhsuk-width-container">
<div class="nhsuk-grid-row">
<div class="nhsuk-grid-column-full">
<div class="nhsuk-feedback-banner__content">
<h2 class="nhsuk-feedback-banner__heading">Tell us what you think about this page</h2>
<p class="nhsuk-feedback-banner__message nhsuk-u-margin-bottom-2">
<a href="https://www.nhs.uk" id="AgreeButton" target="_blank">Take our survey (opens new page)</a>
</p>
